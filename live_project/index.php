...
?>
		...
		<div id="slider1" class="rev_slider"  data-version="5.0">
			<ul>
				...
				<li data-transition="fade">
					<img src="admin-pro/photos/slider-image/<?php echo $row_slider['profile']; ?>"  alt="" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat" style="width: 1920px; height: 692px;">
					...
					<div class="tp-caption sfb tp-resizeme construct-banner-caption" 
				        ...
				        data-start="500">
						<h2><b><?php echo $row_slider['slider_title']; ?></b></h2>
				    </div>
					<div class="tp-caption sfb tp-resizeme construct-banner-caption" 
				        ...
				        data-transform_out="o:0" 
				        data-start="800">
						<h2><?php echo $row_slider['semi_title']; ?></h2>
				    </div>
					<div class="tp-caption sfb tp-resizeme construct-banner-caption" 
								...
								<div class="col-lg-8 col-md-7 col-sm-8">
									...
									<div class="row">
										<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
											<img src="admin-pro/photos/service-image/<?php echo $row_service_detail['profile']; ?>" alt="" style="width: 285px; height: 169px;">
										</div>
											<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
												<p>
													<?php echo substr($services_desc, 0,200)."...."; ?><a href="service.php?services=<?php echo $str_services_type; ?>">Read More</a>
												</p>
											</div>
									</div>
								</div>
	...
	<section id="project-version-one" class="construct home">
		...
		<div class="container-fluid">
			...
			<div class="view-all-btn text-center"><a href="gallery.php" class="view-all hvr-bounce-to-right">view all</a></div>
		</div>
	</section>	
				...
				<div class="owl-carousel owl-theme">
					...
					<div class="item">
						<div class="single-testimonial-construct clearfix">
							<div class="img-holder hvr-rectangle-out">
								<img src="admin-pro/photos/review-image/<?php echo $row_review['profile']; ?>" alt="" style="width: 170px; height: 185px;">
							</div>
							<div class="content">
								<h3><?php echo $row_review['name']; ?></h3>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 single-blog-post">
					<div class="img-holder hvr-rectangle-out">
						<img src="admin-pro/photos/blog-image/<?php echo $row_blog_detail['photos']; ?>" alt="" style="width: 370px; height: 202px;">
						<div class="date">
							<b><?php echo date("d",strtotime($row_blog_detail['added_date'])) ?></b> <br> <?php echo date("M",strtotime($row_blog_detail['added_date'])) ?>
						</div>
					</div>
					<h3><?php echo $row_blog_detail['blog_title']; ?></h3>
					<p><?php echo substr($bolg_desc,0,130)."...."; ?></p>
					<ul>
						<li><span><b><a href="blog_detail.php?blog_id=<?php echo $row_blog_detail['blog_id']; ?>">Read More</a></span></li>
						<li><a href="blog.php?blog=<?php echo $row_blog_detail['blog_category']; ?>"><?php echo $row_blog_detail['blog_category']; ?></a></li>
					</ul>
				</div>
				<?php
						}
			...
			<div class="row">
				<div class="col-lg-12 col-md-12">
					<div class="owl-carousel owl-theme">
						...
						?>
						<div class="item">
							<img src="admin-pro/photos/client-image/<?php echo $row_client['profile']; ?>" alt="" style="width: 196px; height: 45px;">
						</div>
						<?php
								}
								?>

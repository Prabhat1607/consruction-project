<?php
    ...
    $sql_gallery = "SELECT gt.*, st.service_type FROM gallery_tbl gt  LEFT JOIN  service_tbl st ON gt.service_id = st.service_id ORDER BY gallery_id DESC ";
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="page-breadcumb pull-right">
						<i class="fa fa-home"></i> <a href="index.php">Home</a> <i class="fa fa-angle-right"></i> <span>Gallery</span>
					</div> <!-- /.page-breadcumb -->
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<ul class="gallery-filter">
                        ...
                        ?>
                          <li data-filter=".<?php echo $str_services; ?>">
			...
			<div class="row normal-gallery" id="image-gallery-mix">
				...
				<div class="col-lg-4 col-sm-6 col-xs-12 tank outside single-project-item mix">
					<div class="img-wrap">
						<img src="admin-pro/photos/service-image/<?php echo $row_gallery['gallery'] ?>" alt=""  style="width: 370px; height: 294px;">
						<div class="content-wrapper hvr-sweep-to-right">
							<div class="content">
								<div class="button-box">
									<a data-fancybox-group="project-v1" title="<?php echo $row_gallery['service_type']; ?>" class="fancybox" href="admin-pro/photos/service-image/<?php echo $row_gallery['gallery'] ?>"><i class="fa fa-search-plus"></i></a>
								</div>
								<div class="text-box">
									<h4><?php echo $row_gallery['service_type']; ?></h4>

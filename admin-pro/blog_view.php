...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor"> User Blog Lists</h3>
        </div>
        ...
        <div>
            <div class="col-md-12x align-self-center">
                <a href="blog.php"><button class="btn waves-effect waves-light btn-block btn-primary"><i
                            class=" mdi mdi-web"></i> Add New Blog</button></a>
            </div>
            <button
                        ...
                        <table id="example" class="table display table-bordered table-striped">
                            ...
                            <?php
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row_view['blog_title']; ?></td>
                                        <td><?php echo $row_view['blog_tags']; ?></td>
                                        <td><?php echo $row_view['blog_category']; ?></td>

    ...
    <div class="row page-titles">
        ...
        <div>
            <div class="col-md-12x align-self-center">
                <a href="form.php"><button class="btn waves-effect waves-light btn-block btn-primary"><i
                            class=" mdi mdi-account-circle"></i> Add New User</button></a>
            </div>
            <button
                        ...
                        <table id="example" class="table display table-bordered table-striped">
                            ...
                            <?php
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row_view['first_name']; ?></td>
                                        <td><?php echo $row_view['last_Name']; ?></td>
                                        <td><?php echo $row_view['gender']; ?></td>
                                        <td><?php echo $row_view['dob']; ?></td>
                                        <td><?php echo $row_view['username']; ?></td>
                                        <td><?php echo $row_view['password']; ?></td>
                                        <td><?php echo $row_view['street']; ?></td>
                                        <td><?php echo $row_view['city']; ?></td>

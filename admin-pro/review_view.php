<?php
    ...
    $sql_view = "SELECT * FROM review_tbl";
...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor"> Review View Lists</h3>
        </div>
        ...
        <div>
            <div class="col-md-12x align-self-center">
                <a href="review.php"><button class="btn waves-effect waves-light btn-block btn-primary"><i
                            class=" mdi mdi-television-guidex"></i> Add New Review</button></a>
            </div>
            <button
                            ...
                            <?php
                                ...
                                while ($row_view = mysqli_fetch_array($rs_view)) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="photos/review-image/<?php if ($row_view['profile'] == "") {
                                            echo 'user.png';
                                        } else {
                                            echo $row_view['profile'];
                                                ...
                                                <td>
                                            <?php echo $row_view['review']; ?>
                                        </td>
                                        <td class="text-nowrap">
                                            <a href="review_delete.php?id=<?php echo $row_view['review_id']; ?>"

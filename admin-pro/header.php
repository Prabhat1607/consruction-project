<?php
    ...
    {
        $user_data = "SELECT * FROM form_tbl WHERE username = '".$_SESSION['username']."'";
...
<head>
    ...
    <!-- This page CSS -->
    <link href="main/css/pages/inbox.css" rel="stylesheet">
    <!-- chartist CSS -->
    ...
    <link href="main/css/pages/dashboard1.css" rel="stylesheet">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right animated flipInY">
                                <ul class="dropdown-user">
                                    ...
                                    <li role="separator" class="divider"></li>
                                    <li><a href="password.php"><i class=" mdi mdi-key-change"></i>Change Password</a></li>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    ...
                    <li class="user-profile">
                        ...
                        <li> <a class="" href="dashboard.php" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="">Dashboard </span></a>
                        </li>
                        <li> <a class="" href="form_view.php" aria-expanded="false"><i class="mdi mdi-account-box"></i><span class="">User Register</span></a>
                        </li>
                        <li> <a class="" href="blog_view.php" aria-expanded="false"><i class="mdi mdi-web"></i><span class="">Blog</span></a>
                        </li>
                        <li> <a class="" href="service_view.php" aria-expanded="false"><i class="mdi mdi-wrench"></i><span class="">Service</span></a>
                        </li>
                        <li> <a class="" href="gallery_view.php" aria-expanded="false"><i class="mdi mdi-image-multiple"></i><span class="">Gallery</span></a>
                        </li>
                        <li> <a class="" href="slider_view.php" aria-expanded="false"><i class="mdi mdi-arrange-bring-forward"></i><span class="">Slider</span></a>
                        </li>
                        <li> <a class="" href="contact_view.php" aria-expanded="false"><i class="mdi mdi mdi-contacts"></i><span class="">Enquiry</span></a>
                        </li>
